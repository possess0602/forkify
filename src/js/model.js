...
import { API_URL, RES_PER_PAG, KEY } from './config.js';
import { getJSON, sendJSON, AJAX } from './views/helper.js';
export const state = {
  recipe: {},
  search: {
    query: {},
...
const createRecipeObject = function (data) {
  ...
  return {
    ...
    ...(recipe.key && { key: recipe.key }), //因為並非所有給的值都有key因此當有地的話就加入{ key: recipe.key }
  };
};
